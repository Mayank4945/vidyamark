      ...
      if (type === 'class-performance') {
        ...
        const sql = `
          SELECT 
            ...
            ROUND(AVG(m.marks_obtained)::NUMERIC, 2) as average_marks,
            ROUND(PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY m.marks_obtained)::NUMERIC, 2) as median_marks,
        ...
        const sql = `
          SELECT 
            ...
            ROUND(AVG(m.marks_obtained)::NUMERIC, 2) as average_marks,
            ROUND(MAX(m.marks_obtained)::NUMERIC, 2) as highest_marks,
            ROUND(MIN(m.marks_obtained)::NUMERIC, 2) as lowest_marks,
